...
### Alumno:
 Sergio Valentin Ochoa Hernandez
### Maestro:
 Walter Alex Mata Lopez
# Portafolio de programas hechos en Elixir en tercera parcial
---
## Funcion
La funcion simpre se encuentra dentro de un modulo, los nombres de las funciones son iguales que la de las variables,
las variables inician con un caracter alfabetico en minuscula o subrayado.
Pueden terminar con los caracteres ? que se utiliza cuando la funcion retorna true o false y '!' se utiliza en una funcion
...
```
---
## Varios modulos dentro de un mismo archivo
```elixir
defmodule Calculadora do
 def suma(n1,n2) do
 n1 + n2
...
1-Inicia con letra mayúscula
2-Se escribe usando el estilo CamelCase
...
```
---
## Otra forma de anidar los modulos es: 
```elixir
...
se utlizan funciones privadas usando el constructor def; tiene funcion publica y privada 
...
```
---
## Haciendo que una función dependa de otra de diferente aridad, se puede realizar lo siguiente:
```elixir
defmodule Calculadora do
 def suma(n) do
 suma(n,0)
